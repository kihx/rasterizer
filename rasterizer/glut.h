...
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
GLUTAPI void APIENTRY glutInitDisplayString(char *string);
#endif
...
/* GLUT window sub-API. */
GLUTAPI int APIENTRY glutCreateWindow(char *title);
#if defined(_WIN32) && !defined(GLUT_DISABLE_ATEXIT_HACK)
GLUTAPI int APIENTRY __glutCreateWindowWithExit(char *title, void (__cdecl *exitfunc)(int));
#ifndef GLUT_BUILDING_LIB
static int APIENTRY glutCreateWindow_ATEXIT_HACK(char *title) { return __glutCreateWindowWithExit(title, exit); }
...
GLUTAPI void APIENTRY glutSetWindowTitle(char *title);
GLUTAPI void APIENTRY glutSetIconTitle(char *title);
...
GLUTAPI void APIENTRY glutAddMenuEntry(char *label, int value);
GLUTAPI void APIENTRY glutAddSubMenu(char *label, int submenu);
GLUTAPI void APIENTRY glutChangeToMenuEntry(int item, char *label, int value);
GLUTAPI void APIENTRY glutChangeToSubMenu(int item, char *label, int submenu);
...
GLUTAPI int APIENTRY glutExtensionSupported(char *name);
#endif
#if (GLUT_API_VERSION >= 3)
...
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
GLUTAPI int APIENTRY glutBitmapLength(void *font, unsigned char *string);
GLUTAPI int APIENTRY glutStrokeLength(void *font, unsigned char *string);
#endif
...
GLUTAPI void APIENTRY glutGameModeString(char *string);
